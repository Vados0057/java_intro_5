...
public class MinAndMaxWithScanner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Max of yor number is: " + Math.min(num1, num2));
        System.out.println("Min of your numbers is: " + Math.max(num1, num2));
        ...
        System.out.println("Max of yor number is: " + Math.max(Math.max(number1, number2), number3));
        System.out.println("Min of yor number is: " + Math.min(Math.max(number1, number2), number3));
