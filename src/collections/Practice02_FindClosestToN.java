...
public class Practice02_FindClosestToN {
    public static void main(String[] args) {
        ...
        //System.out.println(findClosest(new ArrayList<Integer>(Arrays.asList(7,7,7,7)), 7)); // Exception
        //System.out.println(findClosest(new ArrayList<Integer>(Arrays.asList(3)), 3)); // Exception
    ...
    public static int findClosest(List<Integer> nums, int n){
        ...
        if (set.isEmpty() || (set.size() == 1 && set.first() == n)) throw new RuntimeException("There is not number close to "
        + n + ".");
